...
- (void)setPhotoButtonEnabled:(BOOL)enabled {
    UIButton *photoBtn = (UIButton *)[self viewWithTag:(NSInteger)AlivcRecordSlidButtonTypeTakePhoto];
    photoBtn.hidden= !enabled;
}
